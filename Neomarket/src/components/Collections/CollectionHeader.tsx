  ...
  return (
    <div className="w-full">
      ...
      <div className="relative h-[180px] sm:h-[220px] md:h-[260px] lg:h-[300px] xl:h-[320px] w-full overflow-hidden">
        {bannerFailed ? (
          <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900">
            <h1 className="bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-2xl font-bold text-transparent sm:text-3xl md:text-4xl">
              Collections
            </h1>
          </div>
        ) : (
